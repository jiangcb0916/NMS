...
class Config:
    ...
    SANGFOR_AC_USER_RANK_TOP = env_int("SANGFOR_AC_USER_RANK_TOP", 10000)
    SANGFOR_AC_USER_RANK_CACHE_SECONDS = env_int("SANGFOR_AC_USER_RANK_CACHE_SECONDS", 20)
    ...
    SWITCH_CISCO_SSH_USERNAME = os.environ.get("SWITCH_CISCO_SSH_USERNAME")
    SWITCH_CISCO_SSH_PASSWORD = os.environ.get("SWITCH_CISCO_SSH_PASSWORD")
    SWITCH_CISCO_SSH_PORT = env_int("SWITCH_CISCO_SSH_PORT", SWITCH_SSH_PORT)
    SWITCH_CISCO_SSH_TIMEOUT = env_int("SWITCH_CISCO_SSH_TIMEOUT", SWITCH_SSH_TIMEOUT)
    SWITCH_CISCO_TRANSPORT = os.environ.get("SWITCH_CISCO_TRANSPORT", "auto")
    SWITCH_CISCO_TELNET_PORT = env_int("SWITCH_CISCO_TELNET_PORT", 23)
    SWITCH_TRACE_MAX_HOPS = env_int("SWITCH_TRACE_MAX_HOPS", 5)
    SWITCH_TOPOLOGY_CACHE_SECONDS = env_int("SWITCH_TOPOLOGY_CACHE_SECONDS", 300)
    SWITCH_TOPOLOGY_FORCE_REFRESH_COOLDOWN_SECONDS = env_int(
        "SWITCH_TOPOLOGY_FORCE_REFRESH_COOLDOWN_SECONDS",
        60,
    )
    SWITCH_TOPOLOGY_CACHE_FILE = os.environ.get("SWITCH_TOPOLOGY_CACHE_FILE")
    SWITCH_TOPOLOGY_CORE_MEMBER_A_NAME = os.environ.get("SWITCH_TOPOLOGY_CORE_MEMBER_A_NAME", "HeXinA")
    SWITCH_TOPOLOGY_CORE_MEMBER_B_NAME = os.environ.get("SWITCH_TOPOLOGY_CORE_MEMBER_B_NAME", "HeXinB")
    SWITCH_TOPOLOGY_UPLINK_PATTERNS = os.environ.get(
        "SWITCH_TOPOLOGY_UPLINK_PATTERNS",
        "itn8800,raisecom",
    )
    SWITCH_TOPOLOGY_UNICOM_INTERFACE = os.environ.get(
        "SWITCH_TOPOLOGY_UNICOM_INTERFACE",
        "GE0/0/8",
    )
    SWITCH_TOPOLOGY_TELECOM_INTERFACE = os.environ.get(
        "SWITCH_TOPOLOGY_TELECOM_INTERFACE",
        "GE1/0/6",
    )
    SWITCH_MANAGEMENT_IP_OVERRIDES = os.environ.get(
        "SWITCH_MANAGEMENT_IP_OVERRIDES",
    ...
    HUAWEI_FIREWALL_HA_MODE = os.environ.get("HUAWEI_FIREWALL_HA_MODE", "active-active")
    HUAWEI_FIREWALL_MEMBER_A_NAME = os.environ.get("HUAWEI_FIREWALL_MEMBER_A_NAME", "FW1")
    HUAWEI_FIREWALL_MEMBER_A_IP = os.environ.get("HUAWEI_FIREWALL_MEMBER_A_IP", "172.16.100.1")
    HUAWEI_FIREWALL_MEMBER_A_CORE_LINKS = os.environ.get(
        "HUAWEI_FIREWALL_MEMBER_A_CORE_LINKS",
        "GE0/0/10=GE1/0/0,GE0/0/22=GE1/0/4,GE1/0/8=GE1/0/1",
    )
    HUAWEI_FIREWALL_MEMBER_B_NAME = os.environ.get("HUAWEI_FIREWALL_MEMBER_B_NAME", "FW2")
    HUAWEI_FIREWALL_MEMBER_B_IP = os.environ.get("HUAWEI_FIREWALL_MEMBER_B_IP", "172.16.100.2")
    HUAWEI_FIREWALL_MEMBER_B_CORE_LINKS = os.environ.get(
        "HUAWEI_FIREWALL_MEMBER_B_CORE_LINKS",
